...
// Hi, This is xxxx
    ...
    public static String getUniqueChars(String input) {
        ...
        boolean[] exist = new boolean[256]; // exist, a boolean array using char value as index, default is false
    ...
    /**
     * Using bit operation and assume the char is alphabet only."A~Za~z", [65~122].
     * Note [91~96] is not alphabet
     */
